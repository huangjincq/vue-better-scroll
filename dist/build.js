...
module.exports = __webpack_require__.p + "loading.gif?1f26c50bb56f9f5aba4a0d2b287987e2";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib__ = __webpack_require__(9);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'app',
  components: { vueBetterScroll: __WEBPACK_IMPORTED_MODULE_0__lib__["a" /* default */] },
  data() {
    return {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_better_scroll__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Bubble_vue__ = __webpack_require__(16);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    initScroll() {
      ...
      this.scroll = new __WEBPACK_IMPORTED_MODULE_0_better_scroll___default.a(this.$refs.wrapper, options);
  ...
  components: {
    Bubble: __WEBPACK_IMPORTED_MODULE_1__Bubble_vue___default.a
  }
});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__BScroll_vue__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__BScroll_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__BScroll_vue__);



/* istanbul ignore next */
__WEBPACK_IMPORTED_MODULE_0__BScroll_vue___default.a.install = function (Vue) {
  Vue.component(__WEBPACK_IMPORTED_MODULE_0__BScroll_vue___default.a.name, __WEBPACK_IMPORTED_MODULE_0__BScroll_vue___default.a);
};

/* harmony default export */ __webpack_exports__["a"] = (__WEBPACK_IMPORTED_MODULE_0__BScroll_vue___default.a);

if (typeof window !== 'undefined' && window.Vue) {
  window.Vue.use(__WEBPACK_IMPORTED_MODULE_0__BScroll_vue___default.a);
}
...
// module
exports.push([module.i, "*{padding:0;margin:0}body,html{height:100%;overflow:hidden}#app{font-family:\\\\5FAE\\8F6F\\96C5\\9ED1,Helvetica,Arial,sans-serif;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;color:#2c3e50}header{top:0;text-align:center;z-index:9;height:40px;line-height:40px;color:#fff;background-color:#009a61}.position-box,header{position:fixed;left:0;right:0}.position-box{top:40px;bottom:0}.wrapper{height:100%}.list-content{list-style:none;background:#fff}.list-item{height:60px;line-height:60px;font-size:18px;padding-left:20px;border-bottom:1px solid #e5e5e5}.go-top{position:fixed;right:20px;bottom:20px;background-color:#009a61;border-radius:5px;border:1px solid #fff;color:#fff;padding:10px 15px}", ""]);
...
// module
exports.push([module.i, ".scroll-loading{width:20px;height:20px}.pulldown-wrapper{position:absolute;width:100%;left:0;display:flex;justify-content:center;align-items:center;transition:all}.pulldown-wrapper .after-trigger{margin-top:10px}.pullup-wrapper{width:100%;display:flex;justify-content:center;align-items:center;padding:16px 0}", ""]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('header', [_vm._v("vue-better-scroll demo")]), _vm._v(" "), _c('main', {
    staticClass: "position-box"
  }, [_c('vue-better-scroll', {
    ref: "scroll",
    staticClass: "wrapper",
    attrs: {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._t("default"), _vm._v(" "), _vm._t("pullup", [(_vm.pullUpLoad) ? _c('div', {
...
var update = __webpack_require__(2)("5279cb70", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("02508248", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("e67569d2", content, true);
